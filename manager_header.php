...
// ============================
ob_start();
session_name('LeaveTrackr_Manager');
session_start();
    ...
    <?php
        ...
        switch($page) {
            case 'manager_dashboard.php':
                $pageTitle = "Accueil";
                break;
            case 'manager_history.php':
                $pageTitle = "Historique";
                break;
            case 'manager_leave_requests.php':
                $pageTitle = "Demandes";
                break;
            case 'manager_approval_requests.php':
                $pageTitle = "Demandes en attente d'approbation";
                break;
            default:
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 glass-navbar h-16">
        ...
        <div class="flex items-center justify-between h-full px-4 md:px-6">
            ...
            <div class="hidden md:flex items-center space-x-6 mx-auto">
                <a href="manager_dashboard.php" class="<?= basename($_SERVER['PHP_SELF']) === 'manager_dashboard.php' ? 'bg-blue-600 text-white' : 'text-gray-700 hover:text-blue-600' ?> flex items-center gap-1 font-medium px-3 py-2 rounded-md transition-colors">
                    <i class="fa-solid fa-home"></i>
                    Acceuil
                </a>
                <a href="manager_history.php" class="<?= basename($_SERVER['PHP_SELF']) === 'manager_history.php' ? 'bg-blue-600 text-white' : 'text-gray-700 hover:text-blue-600' ?> flex items-center gap-1 font-medium px-3 py-2 rounded-md transition-colors">
                    <i class="fa-solid fa-clock-rotate-left"></i>
                    Mon Historique
                </a>
                <a href="manager_leave_requests.php" class="<?= basename($_SERVER['PHP_SELF']) === 'manager_leave_requests.php' ? 'bg-blue-600 text-white' : 'text-gray-700 hover:text-blue-600' ?> flex items-center gap-1 font-medium px-3 py-2 rounded-md transition-colors">
                    <i class="fa-solid fa-paper-plane"></i>
                    Mes demandes
                </a>

                <a href="manager_approval_requests.php" class="<?= basename($_SERVER['PHP_SELF']) === 'manager_approval_requests.php' ? 'bg-blue-600 text-white' : 'text-gray-700 hover:text-blue-600' ?> flex items-center gap-1 font-medium px-3 py-2 rounded-md transition-colors">
